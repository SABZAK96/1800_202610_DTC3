(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))e(t);new MutationObserver(t=>{for(const c of t)if(c.type==="childList")for(const a of c.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&e(a)}).observe(document,{childList:!0,subtree:!0});function r(t){const c={};return t.integrity&&(c.integrity=t.integrity),t.referrerPolicy&&(c.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?c.credentials="include":t.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function e(t){if(t.ep)return;t.ep=!0;const c=r(t);fetch(t.href,c)}})();class o extends HTMLElement{constructor(){super(),this.renderNavbar()}renderNavbar(){this.innerHTML=`
        <nav>
        <!--Desktop-->
        <!--Outer Container-->
    ...
    </nav>`}}customElements.define("site-navbar",o);function n(){const l=document.querySelectorAll(".menuButton"),s=window.location.href,r=s.endsWith("/index.html")||s.endsWith("/main.html");l.forEach(e=>{const t=e.parentElement.getAttribute("href");(r&&(t==="/index.html"||t==="/main.html")||s.endsWith(t)||s.includes(t.slice(1)))&&(e.classList.add("bg-white","shadow-2xl"),e.classList.remove("hover:bg-[#aaa9bc]"),e.querySelector("svg").classList.remove("text-white"),e.querySelector("svg").classList.add("text-[var(--primary-green)]"),e.querySelector("svg").nextElementSibling.classList.remove("text-white"),e.querySelector("svg").nextElementSibling.classList.add("text-black"))})}function i(){const l=document.querySelectorAll(".menuButtonMobile"),s=window.location.href,r=s.endsWith("/index.html")||s.endsWith("/main.html");l.forEach(e=>{const t=e.parentElement.getAttribute("href");r&&(t==="/index.html"||t==="/main.html")||s.endsWith(t)?(e.classList.add("bg-[var(--light-grey)]"),e.classList.remove("hover:bg-[#f4f1ea]"),e.querySelector("svg").classList.remove("text-white"),e.querySelector("svg").classList.add("text-[var(--primary-green)]")):s.includes(t.slice(1))&&(e.classList.add("bg-white","shadow-2xl"),e.classList.remove("hover:bg-[#f4f1ea]"),e.querySelector("svg").classList.remove("text-white"),e.querySelector("svg").classList.add("text-[var(--primary-green)]"),e.querySelector("svg").nextElementSibling.classList.remove("text-white"),e.querySelector("svg").nextElementSibling.classList.add("text-black"))})}n();i();class d extends HTMLElement{constructor(){super(),this.renderFooter()}renderNavbar(){this.innerHTML=""}}customElements.define("site-footer",d);
