    ...
    renderNavbar() {
        ...
        <div class="hidden md:flex md:flex-col fixed left-0 justify-between w-50 h-screen px-7 pt-4 pb-10">
            ...
            <div class="flex flex-col gap-4">
                ...
                <!--Menu Item 1-->
                <a href="main.html">
                <button class="h-13 w-full px-4 pt-1 rounded-full bg-white hover:bg-[#aaa9bc] shadow-2xl current-page">
                    <div class="flex flex-1 items-center gap-2 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 200 200" class="text-[#74af27] w-6 pr-1" fill="currentColor">
                ...
                <!--Menu Item 2-->
                <a href="explore.html">
                <button class="h-13 w-full px-4 pt-1 rounded-full hover:bg-[#aaa9bc] text-white ">
                    <div class="flex flex-1 items-center gap-2 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 200 200" class="text-white w-6 pr-1" fill="currentColor">
            ...
            <div>
                ...
                <button class="h-13 w-full px-4 pt-1 rounded-full hover:bg-[#aaa9bc] text-white">
                    <div class="flex flex-1 items-center gap-2 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 200 200" class="text-white w-6" fill="currentColor">
